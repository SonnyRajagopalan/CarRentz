...
public class RentalController {
    ...
    private final RentalsUnavailableRepository rentalsUnavailableRepository;
    private final InvoicesRepository invoicesRepository;
    
    public RentalController (RentalRepository rentalRepository, InventoryRepository inventoryRepository, 
                             RentalsUnavailableRepository rentalsUnavailableRepository, InvoicesRepository invoicesRepository) {
        this.rentalRepository = rentalRepository;
        this.inventoryRepository = inventoryRepository;
        this.rentalsUnavailableRepository = rentalsUnavailableRepository;
    ...
    public ResponseEntity<Void> createUnavailableRental(@RequestBody RentalsUnavailable rA) {
    ...
    public ResponseEntity<Void> returnRental(@PathVariable Long rentalID) {
        ...
        // Add an invoice
        Invoices invoice = new Invoices(rental.getRentalID(), rental.getCustomerID(), rental.getRentalBranchID(),
                                        rental.getReturnBranchID(), rental.getRepID(), rental.getActualCharges(), "Paid");
